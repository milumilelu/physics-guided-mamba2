...
class CanonicalObserver:
    def __init__(self, zero_threshold=1e-10, replacement_delta=1e-6, theta_bins=36):
            ...
            for lo, hi, band in BANDS:
                ...
                if band_ok:
                    with warnings.catch_warnings():
                        ...
                        d = spectrum.directional_band_metrics(batch, .5, [(lo, hi, band)], self.theta_bins).iloc[0]
