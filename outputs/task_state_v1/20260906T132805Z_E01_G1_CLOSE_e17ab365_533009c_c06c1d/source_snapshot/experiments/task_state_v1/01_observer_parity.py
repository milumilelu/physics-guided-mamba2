...
def main():
    ...
    try:
        ...
        observer=CanonicalObserver(c['zero_threshold'],c['replacement_delta'],c['theta_bins'])
        historical=yaml.safe_load((ROOT/'experiments/phase2_5/phase2_5_config.yaml').read_text(encoding='utf-8'))
        require(c['theta_bins']==historical['directional']['theta_bins'],'Angle bins differ from frozen target producer')
